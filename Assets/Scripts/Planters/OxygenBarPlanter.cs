...
public class OxygenBarPlanter : Singleton<OxygenBarPlanter>
{
    // (Optional) Prevent non-singleton constructor use.
    protected OxygenBarPlanter() { }
    ...
    private void plantOxygenBar((int, int, int) room)
    {
        ...
        var target = Resources.Load("Crawler/OxygenBar");
